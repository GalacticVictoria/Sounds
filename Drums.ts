...
function createDrumSet() {
  const pads: DrumPadDefinition[] = [
    { name: "Kick", color: Color.orange, pos: new Vector3(-0.25, 1.1, -2), rot: new Quaternion(0, 0.2, 0, 1), audioFilePath: DefaultAudio.filePaths.instruments.drums.drum, volume: 0.8, pitch: 0.95 },
    ...
    { name: "Tom", color: Color.red, pos: new Vector3(-0.5, 0.9, -2), rot: new Quaternion(0, 0, 0, 1), audioFilePath: DefaultAudio.filePaths.instruments.drums.hit, volume: 0.8, pitch: 1.0 },
