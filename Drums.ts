...
function createDrumSet() {
  const pads: DrumPadDefinition[] = [
    { name: "Kick", color: Color.orange, pos: new Vector3(-0.25, 1.3, -1.9), rot: new Quaternion(0, 0.1, 0, 1), audioFilePath: DefaultAudio.filePaths.instruments.drums.drum, volume: 0.8, pitch: 0.95 },
