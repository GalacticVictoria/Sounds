...
function createDrumSet() {
  const pads: DrumPadDefinition[] = [
    { name: "Kick", color: Color.orange, pos: new Vector3(-0.3, 1.3, -1.9), rot: new Quaternion(0.3, 0.35, 0, 1), scale: new Vector3(0.2, 0.2, 0.2), audioFilePath: DefaultAudio.filePaths.instruments.drums.drum, volume: 0.8, pitch: 0.95 },
