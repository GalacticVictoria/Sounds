...
function createDrumSet() {
  const pads: DrumPadDefinition[] = [
    ...
    { name: "Hi-Hat", color: Color.green, pos: new Vector3(-0.45, 1.6, -1.6), rot: new Quaternion(0, 0.9, 0, 1), scale: new Vector3(0.2, 0.05, 0.2), audioFilePath: DefaultAudio.filePaths.instruments.drums.highHat, volume: 1.0, pitch: 1.2 },
    ...
    { name: "Crash", color: Color.blue, pos: new Vector3(0.45, 1.6, -1.6), rot: new Quaternion(0, -0.9, 0, 1), scale: new Vector3(0.2, 0.05, 0.2), audioFilePath: DefaultAudio.filePaths.instruments.drums.cymbal, volume: 0.8, pitch: 0.92 },
  ];
