...
function createDrumSet() {
  const pads: DrumPadDefinition[] = [
    ...
    { name: "Hi-Hat", color: Color.green, pos: new Vector3(-0.25, 1.6, -2.2), rot: new Quaternion(0, 0.2, 0, 1), scale: new Vector3(0.2, 0.05, 0.2), audioFilePath: DefaultAudio.filePaths.instruments.drums.highHat, volume: 1.2, pitch: 1.2 },
