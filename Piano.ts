...
function createPiano() {
    const keys: PianoKeyDefinition[] = [
        { name: "C Chord Long", color: new Color(1, 0.22, 0), pos: new Vector3(-3, 1.4, -2), rot: new Quaternion(0, 0, 0, 1), scale: new Vector3(0.2, 0.2, 0.4), audioFilePath: DefaultAudio.filePaths.instruments.piano.cChordLong, volume: 1, pitch: 1 },
